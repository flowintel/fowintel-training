...
\begin{frame}{1. Manage Structured Investigations - task}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\textwidth]{img/task_view.png}
	\end{figure}
\end{frame}
...
\begin{frame}{1. Manage Structured Investigations - templates}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\textwidth]{img/template_view.png}
	\end{figure}
\end{frame}
...
\begin{frame}{2. Handle Sensitive \& Privileged Cases}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{img/roles.png}
	\end{figure}
\end{frame}
